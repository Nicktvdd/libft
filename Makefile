...
LDFLAGS = -I libft.h -I ft_printf.h -I get_next_line.h
SRCFILES = ft_isalpha.c ft_isdigit.c ft_isalnum.c ft_isascii.c ft_isprint.c ft_strlen.c ft_memset.c ft_bzero.c \
	...
	ft_putendl_fd.c ft_putnbr_fd.c ft_printf.c get_next_line.c get_next_line_utils.c
